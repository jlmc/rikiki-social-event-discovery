...
/**
 * Shared helpers used by the providers that enrich events with a
 * description/participants from each event's own detail page
 * (agenda-coimbra, convento-sao-francisco, viral-agenda).
 */
...
function splitDescriptionAndParticipants(cleanText) {
...
module.exports = { mapWithLimit, cleanHtmlToText, splitDescriptionAndParticipants };
